                ...
                <td><!-- Button trigger modal -->
                    <div class="justify-content-center" style="text-align: center">
                        <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal">
                            <a href="customer?action=show&id=${customer.id}"><i style="font-size: 1.3em ;text-shadow: 2px 2px  #ccc;color: blue; " class="fa fa-eye" aria-hidden="true" ></i></a>
                        </button>
                    </div>
                    <!-- Modal -->
                                ...
                                <div class="modal-body">
                                    <table class="table" style="background: #8fd19e ;">
                                        ...
                                        <tr>
                                            <th>Name</th>
                                            <td>
                                                <input disabled  type="text" name="name" id="name" value="${customer.name}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th>Birthday</th>
                                            <td>
                                                <input  disabled type="text" name="birthday" id="birthday" value="${customer.birthday}">
                                            </td>
                                        </tr>
                                        <th>Gender</th>
                                        <td>
                                            <div style="width: 50% " class="d-flex">
                                                <input disabled name="gioitinh" type="text" value="${customer.gender}"/>
                                        ...
                                        <tr>
                                            <th>Id Card</th>
                                            <td>
                                                <input  disabled type="text" name="idCard" id="idCard" value="${customer.idCard}">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Phone Number</th>
                                            <td>
                                                <input disabled type="text" name="phoneNumber" id="phoneNumber" value="${customer.phone}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Email</th>
                                            <td>
                                                <input  disabled type="text" name="email" id="email" value="${customer.email}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Type Id</th>
                                            <td>
                                                <input  disabled type="text" name="typeId" id="typeId" value="${customer.idCustomerType}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Address</th>
                                            <td>
                                                <input disabled type="text" name="address" id="address" value="${customer.address}">
                                            </td>
                                        </tr>
